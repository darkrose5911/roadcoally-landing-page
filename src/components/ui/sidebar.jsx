...
const SidebarProvider = React.forwardRef(({ 
  ...
  // We use openMobile and setOpenMobile for mobile, and open and onOpenChange for desktop.
  const [_open, _setOpen] = React.useState(defaultOpen)
  const open_ = open ?? _open
  const setOpen = React.useCallback((value) => {
    const openState = typeof value === "function" ? value(open_) : value
    if (onOpenChange) {
  ...
  const state = open_ ? "expanded" : "collapsed"
  ...
  const contextValue = React.useMemo(
    ...
    [state, open_, setOpen, isMobile, openMobile, setOpenMobile, toggleSidebar]
  )
